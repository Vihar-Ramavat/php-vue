    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-md p-8">
      ...
      <form @submit.prevent="onReset">
        ...
        <div class="mb-6">
          ...
          <div class="relative">
            <input v-if="!showPassword" type="password" id="password" v-model="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            <input v-else type="text" id="password" v-model="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
